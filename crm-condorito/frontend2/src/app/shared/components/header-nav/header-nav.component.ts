...
export class HeaderNavComponent implements OnInit, OnDestroy {
  ...
  navigateTo(route: string): void {
    console.log('🧭 HeaderNav navigateTo called with route:', route);
    if (route) {
      console.log('🧭 Navigating to:', route);
      this.router.navigate([route]);
    } else {
      console.log('❌ No route provided to navigateTo');
    }
  }
   ...
   */
  goToProfile(): void {
    console.log('👤 HeaderNav goToProfile called');
    this.navigateTo('/profile');
    this.closeUserMenu();
  }

  /**
   * Ir a configuración de IA (temporalmente)
   */
  goToCompany(): void {
    console.log('⚙️ HeaderNav goToCompany called');
    this.navigateTo('/ai-config');
    this.closeUserMenu();
  }
   ...
   */
  goToDashboard(): void {
    console.log('📊 HeaderNav goToDashboard called');
