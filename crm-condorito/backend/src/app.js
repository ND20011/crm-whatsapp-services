...
const limiter = rateLimit({
    ...
    max: 10000, // máximo 500 requests por ventana por IP
    message: {
...
// Rutas de testing (sin autenticación) - Solo para desarrollo
app.use('/api/test', require('./routes/testIntelligentRules'));
